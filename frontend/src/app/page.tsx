      ...
      <section className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-blue-900">
            A universal document intelligence platform. Upload a PDF, ask questions in natural language,
            and get answers with source references, page numbers, and an execution trace.
          </p>
        </div>
